...
contract WebReward is IERC20Extended, Auth {
    using SafeMath for uint256;
    ...
    address public contributorFeeReceiver;

    uint256 public liquidityFee;
    uint256 public buybackFee;
    uint256 public reflectionFee;
    uint256 public contributorFee;
    ...
    constructor(
        ...
        _name = "WebReward";
        _symbol = "WRC";
        _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
        ...
        contributorFeeReceiver = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBcontributor = amountBNB.mul(contributorFee).div(
            totalBNBFee
        );

        try distributor.deposit{ value: amountBNBReflection }() {} catch {}
        payable(contributorFeeReceiver).transfer(amountBNBcontributor);
    ...
    function setFeeReceivers(
        ...
        address _contributorFeeReceiver
    ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        contributorFeeReceiver = _contributorFeeReceiver;
    }
